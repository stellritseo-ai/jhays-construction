...
export const Route = createFileRoute("/services/bathroom-fitting")({
  head: () => ({
    meta: [
      { title: "Bathroom Remodeling in Howell, NJ | Jhay's Construction" },
      { name: "description", content: "Expert bathroom remodeling in Howell, NJ. Walk-in showers, custom vanities, tile work, radiant floors, and full gut renovations. Licensed & insured. Serving Howell Township and surrounding areas. Free estimates. Call (732) 673-1569." },
      { property: "og:title", content: "Bathroom Remodeling in Howell, NJ | Jhay's Construction" },
      { property: "og:description", content: "Expert bathroom remodeling in Howell, NJ. Walk-in showers, custom vanities, tile work, and full bathroom renovations. Free estimates from Jhay's Construction." },
      { property: "og:url", content: "https://www.jhaysconstruction.com/services/bathroom-fitting" },
      { property: "og:type", content: "website" },
      { name: "robots", content: "index, follow" },
    ],
    links: [
      { rel: "canonical", href: "https://www.jhaysconstruction.com/services/bathroom-fitting" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "description": "Professional bathroom remodeling services in Howell Township, NJ. Walk-in showers, tile installation, vanities, radiant floor heating, and full bathroom renovations."
        }),
      },
      {
        type: "application/ld+json",
        children: JSON.stringify({
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Bathroom Remodeling", "item": "https://www.jhaysconstruction.com/services/bathroom-fitting" }
          ]
        }),
      },
    ],
      ...
      <section className="relative min-h-[520px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-24">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 mb-5">
            ...
            <span className="text-white/60 text-xs">›</span>
            <span className="text-white/80 text-xs font-semibold">Bathroom Remodeling</span>
          </nav>
          ...
          <p className="text-xl text-white/85 max-w-2xl mb-8 leading-relaxed">
            From full gut renovations to targeted upgrades, we craft bathrooms that combine beauty, functionality, and spa-level comfort. Serving Howell Township, Freehold, Old Bridge, and all of Monmouth County, NJ.
          </p>
      ...
      <section className="bg-gray-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 flex flex-wrap justify-center items-center gap-8 text-center">
          <div>
            ...
            <div className="text-lg font-bold text-white">&amp; Monmouth County Communities</div>
          </div>
