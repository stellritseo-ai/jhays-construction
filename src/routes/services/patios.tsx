...
export const Route = createFileRoute("/services/patios")({
  head: () => ({
    meta: [
      { title: "Patio Installation in Howell, NJ | Jhay's Construction" },
      { name: "description", content: "Custom patio installation and hardscaping in Howell, NJ. Pavers, natural stone, pergolas, and outdoor kitchens. Licensed & insured. Serving Howell Township and surrounding NJ areas. Free estimates. Call (732) 673-1569." },
      { property: "og:title", content: "Patio Installation in Howell, NJ | Jhay's Construction" },
      { property: "og:description", content: "Custom patio installation and hardscaping in Howell, NJ. Pavers, natural stone, pergolas, and outdoor kitchens. Free estimates from Jhay's Construction." },
      { property: "og:url", content: "https://www.jhaysconstruction.com/services/patios" },
      { property: "og:type", content: "website" },
      { name: "robots", content: "index, follow" },
    ],
    links: [
      { rel: "canonical", href: "https://www.jhaysconstruction.com/services/patios" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "description": "Custom patio installation and hardscaping in Howell Township, NJ. Pavers, natural stone, pergolas, outdoor kitchens, and fire pits."
        }),
      },
      {
        type: "application/ld+json",
        children: JSON.stringify({
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Patio Installation", "item": "https://www.jhaysconstruction.com/services/patios" }
          ]
        }),
      },
    ],
      ...
      <section className="relative min-h-[520px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-24">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 mb-5">
            ...
            <span className="text-white/60 text-xs">›</span>
            <span className="text-white/80 text-xs font-semibold">Patio Installation</span>
          </nav>
          ...
          <p className="text-xl text-white/85 max-w-2xl mb-8 leading-relaxed">
            Create the outdoor living space you've always dreamed of. From custom paver patios to pergolas, fire pits, and outdoor kitchens — we turn your backyard into a destination. Serving Howell, NJ and surrounding Monmouth County communities.
          </p>
      ...
      <section className="bg-gray-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 flex flex-wrap justify-center items-center gap-8 text-center">
          <div>
            ...
            <div className="text-lg font-bold text-white">&amp; Surrounding Communities</div>
          </div>
